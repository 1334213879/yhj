...
Route::group([
	...
	$route->group(['prefix' => 'home', 'namespace' => 'Home'], function ($route) {
		// $route->get('aaa', 'LoginController@login');
	});
...
Route::group([
	...
	$route->post('home/verify_code', 'Home\LoginController@verify_code')->name('verify_code');
});
